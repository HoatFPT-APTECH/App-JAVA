...
public class All_for_Web_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_for_web);
    ...
    protected  void onResume(){
        ...
        btngen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String strInput= edtNameWebsite.getText().toString() +"|";
